                ...
                <div className="grid gap-2">
                    ...
                    <div className="flex flex-col">
                        <Button
                            ...
                            onClick={() => {
                                handleSortChange(sort === "name-asc" ? "name-desc" : "name-asc");
                                setOpen(false);
                            }}
                        >
                            <div className="flex items-center">
                            ...
                            {sort === "name-asc" ? <ArrowDown className="h-4 w-4" /> : <ArrowUp className="h-4 w-4" />}
                        </Button>
                    </div>
                    ...
                    <div className="flex flex-col">
                        <Button
                            ...
                            className={cn(
                                "justify-between",
                                (sort === "created-asc" || sort === "created-desc") && "bg-muted",
                            )}
                            onClick={() => {
                                handleSortChange(sort === "created-desc" ? "created-asc" : "created-desc");
                                setOpen(false);
                            }}
                        >
                            <div className="flex items-center">
                            ...
                            {sort === "created-asc" ? <ArrowUp className="h-4 w-4" /> : <ArrowDown className="h-4 w-4" />}
                        </Button>
                    </div>
                </div>
            </PopoverContent>
