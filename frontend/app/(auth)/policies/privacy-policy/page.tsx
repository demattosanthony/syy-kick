  ...
  return (
    <div className="h-screen w-screen overflow-y-auto flex justify-center">
      <div className="max-w-5xl py-12 h-full w-full ">
        <MarkdownViewer
          content={`## Privacy Policy - Yo (Syyclops)

This Privacy Policy describes our policies and procedures on the collection, use and disclosure of your information when you use the Yo platform and tells you about your privacy rights and how the law protects you. We use your personal data to provide and improve our building engineering AI assistant services. By using the platform, you agree to the collection and use of information in accordance with this Privacy Policy.
...
- **Service** refers to the Yo platform.
...
- **Website** refers to Yo, accessible from yo.syyclops.com
