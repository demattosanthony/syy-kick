...
--> statement-breakpoint
ALTER TABLE "workflow_files" ADD CONSTRAINT "workflow_files_workflow_step_id_workflow_steps_id_fk" FOREIGN KEY ("workflow_step_id") REFERENCES "public"."workflow_steps"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "workflow_run_steps_inputs" ADD CONSTRAINT "workflow_run_steps_inputs_file_id_workflow_files_id_fk" FOREIGN KEY ("file_id") REFERENCES "public"."workflow_files"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
