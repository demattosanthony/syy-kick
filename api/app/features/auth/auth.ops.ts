...
import { accessTokens, memberRoles, organizationInvites, organizations, roles, sites, users } from "../../config/schema";
...
export const ops = {
    addAccessToken: async (userId: string, provider: AccessTokenProvider, accessToken: string, refreshToken: string) => {
    ...
    updateAccessToken: async (id: string, accessToken: string, refreshToken: string) => {
