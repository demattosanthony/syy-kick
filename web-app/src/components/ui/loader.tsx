...
export function TextShimmerLoader({
  ...
  return (
    <div
      className={cn(
        // Use more explicit gradient colors instead of CSS variables
        "bg-gradient-to-r from-gray-400 via-gray-700 to-gray-400",
        "bg-[length:200%_auto] bg-clip-text font-medium text-transparent",
        "animate-shimmer", // Use a named animation class instead of inline
        textSizes[size],
        className
      )}
    >
